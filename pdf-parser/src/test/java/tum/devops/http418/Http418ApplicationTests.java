	...
	void testParsePDf() throws Exception {
		...
		final List<PDFParser.Module> expected = List.of(
				...
				new PDFParser.Module("IN0002", "Grundlagenpraktikum: Programmierung",
						"Fundamentals of Programming (Exercises & Laboratory)", 2.3f, 6, 2),
				new PDFParser.Module("IN0006", "Einführung in die Softwaretechnik",
						"Introduction to Software Engineering", 2.3f, 6, 2),
				new PDFParser.Module("IN0008", "Grundlagen: Datenbanken", "Fundamentals of Databases", 3.0f, 6, 2),
				new PDFParser.Module("IN0007", "Grundlagen: Algorithmen und Datenstrukturen",
						"Fundamentals of Algorithms and Data Structures", 3.3f, 6, 2),
				new PDFParser.Module("IN0021", "Einführung in die Wirtschaftsinformatik",
						"Introduction to Information Systems", 3.0f, 5, 2),
				new PDFParser.Module("IN0025", "Informationstechnologien und Gesellschaft (IT und Gesellschaft)",
						"Information Technologies and Society (IT and Society)", 2.3f, 5, 2),
				new PDFParser.Module("IN2258", "Middleware und verteilte Systeme", "Middleware and Distributed Systems",
						1.0f, 5, 2),
				new PDFParser.Module("IN0024", "Operations Research", "Operations Research", 3.7f, 6, 2),
				new PDFParser.Module("IN2085", "Software Engineering für betriebliche Anwendungen - Bachelorkurs",
						"Software Engineering for Business Applications - Bachelor's Course", 2.7f, 5, 2),
				...
				new PDFParser.Module("WI001059", "Buchführung und Rechnungswesen", "Financial Accounting and Reporting",
						3.3f, 6, 3),
				new PDFParser.Module("WI001057_E", "Cost Accounting", "Cost Accounting", 4.0f, 6, 3),
				new PDFParser.Module(
						"MA0901", "Lineare Algebra für Informatik", "Linear Algebra for Informatics", 2.0f, 8, 3),
				new PDFParser.Module("IN0015", "Diskrete Strukturen", "Discrete Structures", 3.7f, 8, 3),
				new PDFParser.Module(
						"MA9712", "Statistik für BWL", "Statistics for Business Administration", 3.3f, 6, 3),
				new PDFParser.Module("IN2288", "Event Processing", "Event Processing", 2.3f, 5, 3),
				new PDFParser.Module("IN0003", "Funktionale Programmierung und Verifikation",
						"Functional Programming and Verification", 3.0f, 5, 4),
				new PDFParser.Module("POL25104", "Datenschutzrecht", "Data Protection Law", 3.3f, 6, 4));
