...
class UserProfileManagerTest extends BaseTest {
	...
	void testUserProfileActions() throws Exception {
		...
		final Profile.Student student = new Profile.Student(null, null, "master testprogram", null, 2, List.of("SysAdmin"),
				List.of("AI", "hardware optimization"), 30, 20, 160, null, null, null, false);
