...
├── models/
│   ├── advisor.py           # StudentAdvisorProfile, AdvisorRequest, ConversationMessage
│   ├── chat.py              # ChatRequest
...
├── services/
│   ├── advisor.py           # Build LLM messages + SSE streaming + sync fallback
...
├── routers/
│   ├── advisor.py           # POST /v1/me/advisor/conversations/{id}/messages
...
└── prompts/
    ├── advisor.txt          # LLM system prompt template for advisor chat
